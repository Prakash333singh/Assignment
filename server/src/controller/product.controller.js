...
const createCar = asyncHandler(async (req, res) => {
  ...
  if (
    ...
    throw new apiError(
      400,
      "All tags (car_type, company, dealer) are required"
    );
  }
...
const uploadAdditionalImages = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new apiResponse(200, car, "Additional images uploaded successfully"));
});
...
const fetchPerticularCar = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new apiResponse(200, car, "Car fetched succefully"));
});
...
const updateCar = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new apiResponse(200, updatedCar, "Car details updated successfully"));
});
...
const deleteImage = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new apiResponse(200, car, "Image deleted successfully"));
});
