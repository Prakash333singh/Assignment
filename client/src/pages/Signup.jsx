...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-700 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full mx-auto  bg-gray-300 p-8 rounded-lg shadow-sm">
